...
'PHIS %', 'PHIE %', 'STPI % #', 'ERR_', 'DEPL', 'PEPH', 'NOP_', 'PU1_ %', 'PU2_ % %', 'PUA1 %', 'PUA2 % %', 'POP1 %', 'POP2 % %', 'BL1_ % $', 'RL1_ % #', 'RL2_ % % !', 'CALL % %', 'RET_', 'STPA % #','STPS % #' , 'STWN % $', 'STRN % $', 'STWV % $', 'STRV % $', 'ALOC', 'ALCR % #', 'STOF % % #', 'AJMP % %', 'CJMP % % %', 'JJMP % % :', 'JTEN @', 'JEND', 'MOV_ % %', 'AND_ % % %', 'OR__ % % %', 'XOR_ % % %', 'SSUB % % %', 'ADDN % % %', 'ADDC % % %', 'SUBN % % %', 'SUBC % % %', 'MULS % %', 'MULL % %', 'DIVM % %', 'SHFT % %', 'BSWP % %', 'MWWN % % %', 'MRWN % % %', 'MWWV % % %', 'MRWV % % %', 'MWBN % %', 'MRBN % %', 'MWBV % %', 'MRBV % %', 'D32U', 'R32U', 'D32S', 'R32S', 'FCST $ # :', 'FCEN', 'SYRB %', 'SYRW %', 'SYRD % %', 'SYRE', 'NSPB !', 'NSPW !', 'ZNXB !', 'ZNXW !', 'BYTE $', 'WORD #', 'DWRD !', 'SYDB', 'SYDW', 'SYDD', 'SYDE', 'SYCB $', 'SYCW #', 'SYCD !', 'SYC0', 'SYC1', 'SYC2', 'SYC3', 'SYC4', 'SYC5', 'SYC6', 'SYC7', 'SYC8', 'SYC9', 'SYCZ', 'SYCS', 'SYCT',
